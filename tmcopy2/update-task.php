                ...
                <tr>
                    ...
                    <td>
                        <select name="list_id">
                            ...
                            <?php 
                                //Connect Database
                                $conn2 = mysqli_connect(LOCALHOST, DB_USERNAME, DB_PASSWORD) or die("Couldn't connect");
...
<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        //Connect Database
        $conn3 = mysqli_connect(LOCALHOST, DB_USERNAME, DB_PASSWORD) or die("Couldn't connect");
