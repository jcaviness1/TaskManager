...
--
-- Table structure for table `listtbls`
--

CREATE TABLE `listtbls` (
...
--
-- Dumping data for table `listtbls`
--

INSERT INTO `listtbls` (`listid`, `listname`, `listdesc`) VALUES
...
INSERT INTO `tasktbl` (`task_id`, `task_name`, `task_description`, `listid`, `priority`, `deadline`) VALUES
...
--
-- Indexes for table `listtbls`
--
ALTER TABLE `listtbls`
...
--
-- AUTO_INCREMENT for table `listtbls`
--
ALTER TABLE `listtbls`
